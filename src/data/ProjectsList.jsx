...
const ProjectsList = [
  {
    name: "AmazonLike",
    imageLink: IMG_amazonlike,
    technoList: "Angular / TypeScript / JAVA / Spring Boot / Spring Security / Postgres SQL / Docker",
    presentation: "Ce projet est une marketplace e-commerce fullstack inspirée de site tels que « Amazon » ou « Leboncoin ».\nLe but de ce projet est de monter en compétences rapidement en travaillant sur une application moderne utilisant les technologies Java/Spring Boot et Angular, ainsi qu'une architecture moderne et conteneurisée via Docker.\n\nNote : l'image est une maquette. Le projet étant en cours de développement, elle ne donne qu'un premier aperçu du visuel qu'aura le site.",
    details: "",
    video: [],
    links: [
      {
        name: "GitHub",
        url: "https://github.com/Florian59c/amazonlike"
      },
    ]
  },
  {
